...
public class BoardService1 {
    public static void main(String[] args) {
        ...
        for (;;) {
            ...
            if (numIn == 1) {
                if (content1.equals("") || writer1.equals("")) {
                    scan.nextLine();
                ...
                } else if (content2.equals("") || writer2.equals("")) {
                    scan.nextLine();
                    System.out.print("작성자 : ");
                    ...
                    System.out.println("[안내] 글쓰기 성공");
                } else if (content3.equals("") || writer3.equals("")) {
                    scan.nextLine();
                    System.out.print("작성자 : ");
                    stringIn = scan.nextLine();
                    writer3 = stringIn;
                ...
                if (!content2.equals("") || !writer2.equals("")) {
                    System.out.println("작성자 : " + writer2);
                    System.out.println("내용 : " + content2);
                    System.out.println("------------------------------------");
                }
                if (!content3.equals("") || !writer3.equals("")) {
