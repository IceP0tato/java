...
public class 실습8 {
    public static void main(String[] args) {
        ...
        int simpResult = simpCal.add(10, 5);
        System.out.println(simpResult);

        // 문제 4
        Checker check = new Checker();
        boolean checker = check.isEven(8);
        if (checker)
        ...
        System.out.println(park.calculateFee(65));
        System.out.println(park.calculateFee(140));
    }
}
